...
const AdminDashboard = lazy(() =>
  import("../features/admin/AdminDashboard.tsx").then((m) => ({
    default: m.AdminDashboard,
  })),
);
const ProfessorDashboard = lazy(() =>
  import("../features/professor/ProfessorDashboard.tsx").then((m) => ({
    default: m.ProfessorDashboard,
  })),
);
const StudentDashboard = lazy(() =>
  import("../features/student/StudentDashboard.tsx").then((m) => ({
