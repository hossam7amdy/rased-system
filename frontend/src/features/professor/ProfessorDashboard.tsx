...
import { attendanceApi, coursesApi } from "../../lib/api.ts";
import { localISODate } from "../../lib/date.ts";
import { ApiError } from "../../lib/response.js";
import type { Course } from "../../lib/types.ts";
import { AttendanceManagementPage } from "./AttendanceManagementPage.tsx";
import { DynamicQRDisplay } from "./DynamicQRDisplay.tsx";
